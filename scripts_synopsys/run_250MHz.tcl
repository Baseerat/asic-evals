gui_start
read_file -format verilog {/home/mshahbaz/asic-evals/baseerat_mux.v}
compile -exact_map
change_selection [::snpsGuiSyn::get_current_design]
analyze -library WORK -format verilog {/home/mshahbaz/asic-evals/baseerat_mux.v}
...
uplevel #0 { report_timing -path full -delay max -nworst 1 -max_paths 1 -loops -significant_digits 2 -sort_by group }
